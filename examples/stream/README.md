...
- Send `extended-markdown` to stream a release-status update where every delta sets `textFormat: 'extendedmarkdown'` — the task list and strikethrough render as they stream, which plain markdown can't do (validates PR #762).
