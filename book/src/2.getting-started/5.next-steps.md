...
Now that you've created your first Spark application and understand the basics of development, you're ready to explore more advanced topics. This guide will help you navigate the rest of the documentation based on your specific interests and needs.

## Where to Go Next

Depending on what you want to build, you might want to focus on different areas of the Spark.JS documentation:
...
1. **[AI Overview](../8.ai/README.md)**: Get an introduction to AI capabilities in Spark
...
The Spark.JS repository includes several sample projects that demonstrate different capabilities:
...
```typescript
import { OpenAIClient } from '@microsoft/spark.openai';
...
Now that you have the knowledge to get started, here's a suggested approach for building your first real Spark application:
...
- **GitHub Issues**: Check existing issues or create a new one on the [Spark.JS GitHub repository](https://github.com/microsoft/spark.js/issues)
- **Microsoft Q&A**: Ask questions on [Microsoft Q&A](https://learn.microsoft.com/en-us/answers/topics/teams-development.html)

## Contributing to Spark.JS

If you'd like to contribute to Spark.JS:

1. **Fork the repository**: Create your own fork of the [Spark.JS repository](https://github.com/microsoft/spark.js)
...
You've now completed the Getting Started section of the Spark.JS documentation! You have the knowledge to create, run, and develop Spark applications. As you continue your journey, refer back to this documentation and explore the specific sections that are most relevant to your needs.

Happy building with Spark.JS!
