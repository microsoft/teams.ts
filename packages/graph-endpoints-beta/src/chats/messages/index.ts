...
export interface IEndpoints {
  ...
  'DELETE /chats/{chat-id}/messages/{chatMessage-id}/hostedContents/{chatMessageHostedContent-id}': Operation<
    ...
    'delete'
  >;
  'POST /chats/{chat-id}/messages/replyWithQuote': Operation<
...
export const replyWithQuote = {
   ...
   */
  create: function create(
    body: IEndpoints['POST /chats/{chat-id}/messages/replyWithQuote']['body'],
    params?: IEndpoints['POST /chats/{chat-id}/messages/replyWithQuote']['parameters']
  ): EndpointRequest<IEndpoints['POST /chats/{chat-id}/messages/replyWithQuote']['response']> {
    return {
      ver: 'beta',
      method: 'post',
      path: '/chats/{chat-id}/messages/replyWithQuote',
      paramDefs: {
        path: ['chat-id'],
      },
      params,
