...
export interface IEndpoints {
  ...
  'POST /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/forward': Operation<
    ...
    'post'
  >;
  'POST /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/markAsJunk': Operation<
    '/users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/markAsJunk',
    'post'
  >;
  'POST /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/markAsNotJunk': Operation<
    '/users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/markAsNotJunk',
    'post'
  >;
  'GET /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/mentions': Operation<
    '/users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/mentions',
    'get'
  >;
  'POST /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/mentions': Operation<
    '/users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/mentions',
    'post'
  >;
  'GET /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/mentions/{mention-id}': Operation<
    '/users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/mentions/{mention-id}',
    'get'
  >;
  'DELETE /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/mentions/{mention-id}': Operation<
    '/users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/mentions/{mention-id}',
    'delete'
  >;
  ...
  'POST /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/send': Operation<
    ...
    'post'
  >;
  'POST /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/unsubscribe': Operation<
    '/users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/unsubscribe',
    'post'
  >;
}
...
export const markAsJunk = {
  /**
   * `POST /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/markAsJunk`
   *
   ...
   */
  create: function create(
    body: IEndpoints['POST /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/markAsJunk']['body'],
    params?: IEndpoints['POST /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/markAsJunk']['parameters']
  ): EndpointRequest<
    IEndpoints['POST /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/markAsJunk']['response']
  > {
    return {
      ver: 'beta',
      method: 'post',
      path: '/users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/markAsJunk',
      paramDefs: {
        path: ['user-id', 'mailFolder-id', 'message-id'],
      },
      params,
...
export const markAsNotJunk = {
  /**
   * `POST /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/markAsNotJunk`
   *
   ...
   */
  create: function create(
    body: IEndpoints['POST /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/markAsNotJunk']['body'],
    params?: IEndpoints['POST /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/markAsNotJunk']['parameters']
  ): EndpointRequest<
    IEndpoints['POST /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/markAsNotJunk']['response']
  > {
    return {
      ver: 'beta',
      method: 'post',
      path: '/users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/markAsNotJunk',
      paramDefs: {
        path: ['user-id', 'mailFolder-id', 'message-id'],
      },
      params,
...
export const mentions = {
  /**
   * `GET /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/mentions`
   *
   ...
   */
  list: function list(
    params?: IEndpoints['GET /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/mentions']['parameters']
  ): EndpointRequest<
    IEndpoints['GET /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/mentions']['response']
  > {
    return {
      ver: 'beta',
      method: 'get',
      path: '/users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/mentions',
      paramDefs: {
        query: ['$top', '$skip', '$search', '$filter', '$count', '$orderby', '$select', '$expand'],
        path: ['user-id', 'mailFolder-id', 'message-id'],
      },
  ...
  /**
   * `POST /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/mentions`
   *
   */
  create: function create(
    body: IEndpoints['POST /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/mentions']['body'],
    params?: IEndpoints['POST /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/mentions']['parameters']
  ): EndpointRequest<
    IEndpoints['POST /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/mentions']['response']
  > {
    return {
      ver: 'beta',
      method: 'post',
  ...
  /**
   * `GET /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/mentions/{mention-id}`
   *
   * A collection of mentions in the message, ordered by the createdDateTime from the newest to the oldest. By default, a GET /messages does not return this property unless you apply $expand on the property.
   */
  get: function get(
    params?: IEndpoints['GET /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/mentions/{mention-id}']['parameters']
  ): EndpointRequest<
    IEndpoints['GET /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/mentions/{mention-id}']['response']
  > {
    return {
      ver: 'beta',
      method: 'get',
      path: '/users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/mentions/{mention-id}',
      paramDefs: {
        query: ['$select', '$expand'],
        path: ['user-id', 'mailFolder-id', 'message-id', 'mention-id'],
      },
      params,
    };
  },
  /**
   * `DELETE /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/mentions/{mention-id}`
   *
   */
  del: function del(
    params?: IEndpoints['DELETE /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/mentions/{mention-id}']['parameters']
  ): EndpointRequest<
    IEndpoints['DELETE /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/mentions/{mention-id}']['response']
  > {
    return {
      ver: 'beta',
      method: 'delete',
...
export const unsubscribe = {
  /**
   * `POST /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/unsubscribe`
   *
   ...
   */
  create: function create(
    params?: IEndpoints['POST /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/unsubscribe']['parameters']
  ): EndpointRequest<
    IEndpoints['POST /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/unsubscribe']['response']
  > {
    return {
      ver: 'beta',
      method: 'post',
      path: '/users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/unsubscribe',
      paramDefs: {
        path: ['user-id', 'mailFolder-id', 'message-id'],
      },
      params,
