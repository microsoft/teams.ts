...
export interface IEndpoints {
  ...
  'POST /users/{user-id}/events/{event-id}/accept': Operation<
    '/users/{user-id}/events/{event-id}/accept',
    'post'
  >;
  'GET /users/{user-id}/events/{event-id}/calendar': Operation<
  ...
  'POST /users/{user-id}/events/{event-id}/cancel': Operation<
    ...
    'post'
  >;
  'POST /users/{user-id}/events/{event-id}/decline': Operation<
  ...
  'POST /users/{user-id}/events/{event-id}/dismissReminder': Operation<
    ...
    'post'
  >;
  'GET /users/{user-id}/events/{event-id}/extensions': Operation<
    '/users/{user-id}/events/{event-id}/extensions',
    'get'
  >;
  'POST /users/{user-id}/events/{event-id}/extensions': Operation<
    '/users/{user-id}/events/{event-id}/extensions',
    'post'
  >;
  'GET /users/{user-id}/events/{event-id}/extensions/{extension-id}': Operation<
    '/users/{user-id}/events/{event-id}/extensions/{extension-id}',
    'get'
  >;
  'PATCH /users/{user-id}/events/{event-id}/extensions/{extension-id}': Operation<
    '/users/{user-id}/events/{event-id}/extensions/{extension-id}',
    'patch'
  >;
  'DELETE /users/{user-id}/events/{event-id}/extensions/{extension-id}': Operation<
    '/users/{user-id}/events/{event-id}/extensions/{extension-id}',
    'delete'
  >;
  'POST /users/{user-id}/events/{event-id}/forward': Operation<
    '/users/{user-id}/events/{event-id}/forward',
    'post'
  >;
  'GET /users/{user-id}/events/{event-id}/instances': Operation<
  ...
  'POST /users/{user-id}/events/{event-id}/permanentDelete': Operation<
    ...
    'post'
  >;
  'POST /users/{user-id}/events/{event-id}/snoozeReminder': Operation<
    '/users/{user-id}/events/{event-id}/snoozeReminder',
    'post'
  >;
  'POST /users/{user-id}/events/{event-id}/tentativelyAccept': Operation<
...
export const accept = {
  ...
  create: function create(
    body: IEndpoints['POST /users/{user-id}/events/{event-id}/accept']['body'],
    params?: IEndpoints['POST /users/{user-id}/events/{event-id}/accept']['parameters']
  ): EndpointRequest<IEndpoints['POST /users/{user-id}/events/{event-id}/accept']['response']> {
    return {
      ver: 'beta',
      method: 'post',
...
export const calendar = {
   ...
   */
  get: function get(
    params?: IEndpoints['GET /users/{user-id}/events/{event-id}/calendar']['parameters']
  ): EndpointRequest<IEndpoints['GET /users/{user-id}/events/{event-id}/calendar']['response']> {
    return {
      ver: 'beta',
      method: 'get',
...
export const decline = {
   ...
   */
  create: function create(
    body: IEndpoints['POST /users/{user-id}/events/{event-id}/decline']['body'],
    params?: IEndpoints['POST /users/{user-id}/events/{event-id}/decline']['parameters']
  ): EndpointRequest<IEndpoints['POST /users/{user-id}/events/{event-id}/decline']['response']> {
    return {
      ver: 'beta',
      method: 'post',
...
export const extensions = {
   ...
   */
  list: function list(
    params?: IEndpoints['GET /users/{user-id}/events/{event-id}/extensions']['parameters']
  ): EndpointRequest<IEndpoints['GET /users/{user-id}/events/{event-id}/extensions']['response']> {
    return {
      ver: 'beta',
      method: 'get',
   ...
   */
  create: function create(
    body: IEndpoints['POST /users/{user-id}/events/{event-id}/extensions']['body'],
    params?: IEndpoints['POST /users/{user-id}/events/{event-id}/extensions']['parameters']
  ): EndpointRequest<IEndpoints['POST /users/{user-id}/events/{event-id}/extensions']['response']> {
    return {
      ver: 'beta',
      method: 'post',
      path: '/users/{user-id}/events/{event-id}/extensions',
   ...
   */
  get: function get(
    params?: IEndpoints['GET /users/{user-id}/events/{event-id}/extensions/{extension-id}']['parameters']
  ): EndpointRequest<
    IEndpoints['GET /users/{user-id}/events/{event-id}/extensions/{extension-id}']['response']
  > {
    return {
      ver: 'beta',
      method: 'get',
  ...
  update: function update(
    body: IEndpoints['PATCH /users/{user-id}/events/{event-id}/extensions/{extension-id}']['body'],
    params?: IEndpoints['PATCH /users/{user-id}/events/{event-id}/extensions/{extension-id}']['parameters']
  ): EndpointRequest<
    IEndpoints['PATCH /users/{user-id}/events/{event-id}/extensions/{extension-id}']['response']
  > {
    return {
      ver: 'beta',
      method: 'patch',
   ...
   */
  del: function del(
    params?: IEndpoints['DELETE /users/{user-id}/events/{event-id}/extensions/{extension-id}']['parameters']
  ): EndpointRequest<
    IEndpoints['DELETE /users/{user-id}/events/{event-id}/extensions/{extension-id}']['response']
  > {
    return {
      ver: 'beta',
      method: 'delete',
...
copy of the meeting event. This convenience is not available when forwarding from an Outlook.com account.
  */
  create: function create(
    body: IEndpoints['POST /users/{user-id}/events/{event-id}/forward']['body'],
    params?: IEndpoints['POST /users/{user-id}/events/{event-id}/forward']['parameters']
  ): EndpointRequest<IEndpoints['POST /users/{user-id}/events/{event-id}/forward']['response']> {
    return {
      ver: 'beta',
      method: 'post',
...
export const instances = {
   ...
   */
  list: function list(
    params?: IEndpoints['GET /users/{user-id}/events/{event-id}/instances']['parameters']
  ): EndpointRequest<IEndpoints['GET /users/{user-id}/events/{event-id}/instances']['response']> {
    return {
      ver: 'beta',
      method: 'get',
...
export const snoozeReminder = {
   ...
   */
  create: function create(
    body: IEndpoints['POST /users/{user-id}/events/{event-id}/snoozeReminder']['body'],
    params?: IEndpoints['POST /users/{user-id}/events/{event-id}/snoozeReminder']['parameters']
  ): EndpointRequest<
    IEndpoints['POST /users/{user-id}/events/{event-id}/snoozeReminder']['response']
  > {
    return {
      ver: 'beta',
      method: 'post',
...
export const tentativelyAccept = {
   ...
   */
  create: function create(
    body: IEndpoints['POST /users/{user-id}/events/{event-id}/tentativelyAccept']['body'],
    params?: IEndpoints['POST /users/{user-id}/events/{event-id}/tentativelyAccept']['parameters']
  ): EndpointRequest<
    IEndpoints['POST /users/{user-id}/events/{event-id}/tentativelyAccept']['response']
  > {
    return {
      ver: 'beta',
      method: 'post',
