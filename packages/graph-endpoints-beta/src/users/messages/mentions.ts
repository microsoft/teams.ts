...
): EndpointRequest<IEndpoints['GET /users/{user-id}/messages/{message-id}/mentions']['response']> {
  return {
    ver: 'beta',
    method: 'get',
...
): EndpointRequest<IEndpoints['POST /users/{user-id}/messages/{message-id}/mentions']['response']> {
  return {
    ver: 'beta',
    method: 'post',
    path: '/users/{user-id}/messages/{message-id}/mentions',
