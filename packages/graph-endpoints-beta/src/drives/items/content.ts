...
): EndpointRequest<IEndpoints['GET /drives/{drive-id}/items/{driveItem-id}/content']['response']> {
  return {
    ver: 'beta',
    method: 'get',
    path: '/drives/{drive-id}/items/{driveItem-id}/content',
...
): EndpointRequest<IEndpoints['PUT /drives/{drive-id}/items/{driveItem-id}/content']['response']> {
  return {
    ver: 'beta',
    method: 'put',
    path: '/drives/{drive-id}/items/{driveItem-id}/content',
