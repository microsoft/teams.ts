...
export interface IEndpoints {
  ...
  'POST /drives/{drive-id}/list/items/{listItem-id}/permissions': Operation<
    ...
    'post'
  >;
  'POST /drives/{drive-id}/list/items/{listItem-id}/permissions/{permission-id}/grant': Operation<
    '/drives/{drive-id}/list/items/{listItem-id}/permissions/{permission-id}/grant',
    'post'
  >;
  'POST /drives/{drive-id}/list/items/{listItem-id}/permissions/{permission-id}/revokeGrants': Operation<
    '/drives/{drive-id}/list/items/{listItem-id}/permissions/{permission-id}/revokeGrants',
    'post'
  >;
}
...
> {
  return {
    ...
    paramDefs: {
      header: ['If-Match'],
      path: ['drive-id', 'listItem-id', 'permission-id'],
    },
    params,
  };
}
...
export const grant = {
  /**
   * `POST /drives/{drive-id}/list/items/{listItem-id}/permissions/{permission-id}/grant`
   *
   * Grant users access to a link represented by a permission.
   */
  create: function create(
    body: IEndpoints['POST /drives/{drive-id}/list/items/{listItem-id}/permissions/{permission-id}/grant']['body'],
    params?: IEndpoints['POST /drives/{drive-id}/list/items/{listItem-id}/permissions/{permission-id}/grant']['parameters']
  ): EndpointRequest<
    IEndpoints['POST /drives/{drive-id}/list/items/{listItem-id}/permissions/{permission-id}/grant']['response']
  > {
    return {
      ver: 'beta',
      method: 'post',
      path: '/drives/{drive-id}/list/items/{listItem-id}/permissions/{permission-id}/grant',
      paramDefs: {
        path: ['drive-id', 'listItem-id', 'permission-id'],
      },
      params,
...
export const revokeGrants = {
  /**
   * `POST /drives/{drive-id}/list/items/{listItem-id}/permissions/{permission-id}/revokeGrants`
   *
   * Revoke access to a listItem or driveItem granted via a sharing link by removing the specified recipient from the link.
   */
  create: function create(
    body: IEndpoints['POST /drives/{drive-id}/list/items/{listItem-id}/permissions/{permission-id}/revokeGrants']['body'],
    params?: IEndpoints['POST /drives/{drive-id}/list/items/{listItem-id}/permissions/{permission-id}/revokeGrants']['parameters']
  ): EndpointRequest<
    IEndpoints['POST /drives/{drive-id}/list/items/{listItem-id}/permissions/{permission-id}/revokeGrants']['response']
  > {
    return {
      ver: 'beta',
      method: 'post',
      path: '/drives/{drive-id}/list/items/{listItem-id}/permissions/{permission-id}/revokeGrants',
      paramDefs: {
        path: ['drive-id', 'listItem-id', 'permission-id'],
      },
      params,
