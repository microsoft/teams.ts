...
export interface IEndpoints {
  ...
  'POST /me/mailFolders/{mailFolder-id}/messages/{message-id}/copy': Operation<
    ...
    'post'
  >;
  'POST /me/mailFolders/{mailFolder-id}/messages/{message-id}/createForward': Operation<
    '/me/mailFolders/{mailFolder-id}/messages/{message-id}/createForward',
    'post'
  >;
  'POST /me/mailFolders/{mailFolder-id}/messages/{message-id}/createReply': Operation<
    '/me/mailFolders/{mailFolder-id}/messages/{message-id}/createReply',
    'post'
  >;
  'POST /me/mailFolders/{mailFolder-id}/messages/{message-id}/createReplyAll': Operation<
  ...
  'POST /me/mailFolders/{mailFolder-id}/messages/{message-id}/forward': Operation<
    ...
    'post'
  >;
  'POST /me/mailFolders/{mailFolder-id}/messages/{message-id}/markAsJunk': Operation<
    '/me/mailFolders/{mailFolder-id}/messages/{message-id}/markAsJunk',
    'post'
  >;
  ...
  'DELETE /me/mailFolders/{mailFolder-id}/messages/{message-id}/mentions/{mention-id}': Operation<
    ...
    'delete'
  >;
  'POST /me/mailFolders/{mailFolder-id}/messages/{message-id}/move': Operation<
    '/me/mailFolders/{mailFolder-id}/messages/{message-id}/move',
    'post'
  >;
  'POST /me/mailFolders/{mailFolder-id}/messages/{message-id}/permanentDelete': Operation<
  ...
  'POST /me/mailFolders/{mailFolder-id}/messages/{message-id}/send': Operation<
    ...
    'post'
  >;
  'POST /me/mailFolders/{mailFolder-id}/messages/{message-id}/unsubscribe': Operation<
    '/me/mailFolders/{mailFolder-id}/messages/{message-id}/unsubscribe',
    'post'
  >;
}
...
- Add any attachments and S/MIME properties to the MIME content. Send the draft message in a subsequent operation. Alternatively, forward a message in a single operation.
  */
  create: function create(
    body: IEndpoints['POST /me/mailFolders/{mailFolder-id}/messages/{message-id}/createForward']['body'],
    params?: IEndpoints['POST /me/mailFolders/{mailFolder-id}/messages/{message-id}/createForward']['parameters']
  ): EndpointRequest<
    IEndpoints['POST /me/mailFolders/{mailFolder-id}/messages/{message-id}/createForward']['response']
  > {
    return {
      ver: 'beta',
      method: 'post',
      path: '/me/mailFolders/{mailFolder-id}/messages/{message-id}/createForward',
      paramDefs: {
        path: ['mailFolder-id', 'message-id'],
      },
      params,
...
- Add any attachments and S/MIME properties to the MIME content. Send the draft message in a subsequent operation. Alternatively, reply to a message in a single operation.
  */
  create: function create(
    body: IEndpoints['POST /me/mailFolders/{mailFolder-id}/messages/{message-id}/createReply']['body'],
    params?: IEndpoints['POST /me/mailFolders/{mailFolder-id}/messages/{message-id}/createReply']['parameters']
  ): EndpointRequest<
    IEndpoints['POST /me/mailFolders/{mailFolder-id}/messages/{message-id}/createReply']['response']
  > {
    return {
      ver: 'beta',
      method: 'post',
      path: '/me/mailFolders/{mailFolder-id}/messages/{message-id}/createReply',
      paramDefs: {
        path: ['mailFolder-id', 'message-id'],
      },
      params,
...
- Add any attachments and S/MIME properties to the MIME content. Send the draft message in a subsequent operation. Alternatively, reply-all to a message in a single action.
  */
  create: function create(
    body: IEndpoints['POST /me/mailFolders/{mailFolder-id}/messages/{message-id}/createReplyAll']['body'],
    params?: IEndpoints['POST /me/mailFolders/{mailFolder-id}/messages/{message-id}/createReplyAll']['parameters']
  ): EndpointRequest<
    IEndpoints['POST /me/mailFolders/{mailFolder-id}/messages/{message-id}/createReplyAll']['response']
  > {
    return {
      ver: 'beta',
      method: 'post',
      path: '/me/mailFolders/{mailFolder-id}/messages/{message-id}/createReplyAll',
      paramDefs: {
        path: ['mailFolder-id', 'message-id'],
      },
      params,
...
export const extensions = {
  ...
  > {
    return {
      ...
      paramDefs: {
        query: ['$select', '$expand'],
        path: ['mailFolder-id', 'message-id', 'extension-id'],
      },
      params,
    };
  },
...
export const markAsJunk = {
  /**
   * `POST /me/mailFolders/{mailFolder-id}/messages/{message-id}/markAsJunk`
   *
   ...
   */
  create: function create(
    body: IEndpoints['POST /me/mailFolders/{mailFolder-id}/messages/{message-id}/markAsJunk']['body'],
    params?: IEndpoints['POST /me/mailFolders/{mailFolder-id}/messages/{message-id}/markAsJunk']['parameters']
  ): EndpointRequest<
    IEndpoints['POST /me/mailFolders/{mailFolder-id}/messages/{message-id}/markAsJunk']['response']
  > {
    return {
      ver: 'beta',
      method: 'post',
      path: '/me/mailFolders/{mailFolder-id}/messages/{message-id}/markAsJunk',
      paramDefs: {
        path: ['mailFolder-id', 'message-id'],
      },
      params,
...
export const mentions = {
  ...
  > {
    return {
      ...
      paramDefs: {
        query: ['$select', '$expand'],
        path: ['mailFolder-id', 'message-id', 'mention-id'],
      },
      params,
    };
  },
...
export const move = {
   ...
   */
  create: function create(
    body: IEndpoints['POST /me/mailFolders/{mailFolder-id}/messages/{message-id}/move']['body'],
    params?: IEndpoints['POST /me/mailFolders/{mailFolder-id}/messages/{message-id}/move']['parameters']
  ): EndpointRequest<
    IEndpoints['POST /me/mailFolders/{mailFolder-id}/messages/{message-id}/move']['response']
  > {
    return {
      ver: 'beta',
      method: 'post',
      path: '/me/mailFolders/{mailFolder-id}/messages/{message-id}/move',
      paramDefs: {
        path: ['mailFolder-id', 'message-id'],
      },
      params,
...
export const permanentDelete = {
   ...
   */
  create: function create(
    params?: IEndpoints['POST /me/mailFolders/{mailFolder-id}/messages/{message-id}/permanentDelete']['parameters']
  ): EndpointRequest<
    IEndpoints['POST /me/mailFolders/{mailFolder-id}/messages/{message-id}/permanentDelete']['response']
  > {
    return {
      ver: 'beta',
      method: 'post',
      path: '/me/mailFolders/{mailFolder-id}/messages/{message-id}/permanentDelete',
      paramDefs: {
        path: ['mailFolder-id', 'message-id'],
      },
      params,
...
export const unsubscribe = {
  /**
   * `POST /me/mailFolders/{mailFolder-id}/messages/{message-id}/unsubscribe`
   *
   ...
   */
  create: function create(
    params?: IEndpoints['POST /me/mailFolders/{mailFolder-id}/messages/{message-id}/unsubscribe']['parameters']
  ): EndpointRequest<
    IEndpoints['POST /me/mailFolders/{mailFolder-id}/messages/{message-id}/unsubscribe']['response']
  > {
    return {
      ver: 'beta',
      method: 'post',
      path: '/me/mailFolders/{mailFolder-id}/messages/{message-id}/unsubscribe',
      paramDefs: {
        path: ['mailFolder-id', 'message-id'],
      },
      params,
