...
export interface IEndpoints {
  ...
  'POST /groups/{group-id}/sites/{site-id}/lists/{list-id}/permissions/{permission-id}/grant': Operation<
    ...
    'post'
  >;
  'POST /groups/{group-id}/sites/{site-id}/lists/{list-id}/permissions/{permission-id}/revokeGrants': Operation<
    '/groups/{group-id}/sites/{site-id}/lists/{list-id}/permissions/{permission-id}/revokeGrants',
    'post'
  >;
}
...
> {
  return {
    ...
    paramDefs: {
      header: ['If-Match'],
      path: ['group-id', 'site-id', 'list-id', 'permission-id'],
    },
    params,
  };
}
...
export const revokeGrants = {
  /**
   * `POST /groups/{group-id}/sites/{site-id}/lists/{list-id}/permissions/{permission-id}/revokeGrants`
   *
   * Revoke access to a listItem or driveItem granted via a sharing link by removing the specified recipient from the link.
   */
  create: function create(
    body: IEndpoints['POST /groups/{group-id}/sites/{site-id}/lists/{list-id}/permissions/{permission-id}/revokeGrants']['body'],
    params?: IEndpoints['POST /groups/{group-id}/sites/{site-id}/lists/{list-id}/permissions/{permission-id}/revokeGrants']['parameters']
  ): EndpointRequest<
    IEndpoints['POST /groups/{group-id}/sites/{site-id}/lists/{list-id}/permissions/{permission-id}/revokeGrants']['response']
  > {
    return {
      ver: 'beta',
      method: 'post',
      path: '/groups/{group-id}/sites/{site-id}/lists/{list-id}/permissions/{permission-id}/revokeGrants',
      paramDefs: {
        path: ['group-id', 'site-id', 'list-id', 'permission-id'],
      },
      params,
