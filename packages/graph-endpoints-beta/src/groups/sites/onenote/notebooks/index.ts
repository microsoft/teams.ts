...
export interface IEndpoints {
  'DELETE /groups/{group-id}/sites/{site-id}/onenote/notebooks/{notebook-id}': Operation<
    '/groups/{group-id}/sites/{site-id}/onenote/notebooks/{notebook-id}',
    'delete'
  >;
  'GET /groups/{group-id}/sites/{site-id}/onenote/notebooks': Operation<
    '/groups/{group-id}/sites/{site-id}/onenote/notebooks',
    'get'
  >;
  'GET /groups/{group-id}/sites/{site-id}/onenote/notebooks/{notebook-id}': Operation<
    '/groups/{group-id}/sites/{site-id}/onenote/notebooks/{notebook-id}',
    'get'
  >;
  'PATCH /groups/{group-id}/sites/{site-id}/onenote/notebooks/{notebook-id}': Operation<
    '/groups/{group-id}/sites/{site-id}/onenote/notebooks/{notebook-id}',
    'patch'
  >;
  'POST /groups/{group-id}/sites/{site-id}/onenote/notebooks': Operation<
    '/groups/{group-id}/sites/{site-id}/onenote/notebooks',
    'post'
  >;
...
/**
 * `DELETE /groups/{group-id}/sites/{site-id}/onenote/notebooks/{notebook-id}`
 *
 */
export function del(
  params?: IEndpoints['DELETE /groups/{group-id}/sites/{site-id}/onenote/notebooks/{notebook-id}']['parameters']
): EndpointRequest<
  IEndpoints['DELETE /groups/{group-id}/sites/{site-id}/onenote/notebooks/{notebook-id}']['response']
> {
  return {
    ver: 'beta',
    method: 'delete',
...
/**
 * `GET /groups/{group-id}/sites/{site-id}/onenote/notebooks`
 *
 * The collection of OneNote notebooks that the user or group owns. Read-only. Nullable.
 */
export function list(
  params?: IEndpoints['GET /groups/{group-id}/sites/{site-id}/onenote/notebooks']['parameters']
): EndpointRequest<
  IEndpoints['GET /groups/{group-id}/sites/{site-id}/onenote/notebooks']['response']
> {
  return {
    ver: 'beta',
    method: 'get',
...
/**
 * `GET /groups/{group-id}/sites/{site-id}/onenote/notebooks/{notebook-id}`
 *
 * The collection of OneNote notebooks that the user or group owns. Read-only. Nullable.
 */
export function get(
  params?: IEndpoints['GET /groups/{group-id}/sites/{site-id}/onenote/notebooks/{notebook-id}']['parameters']
): EndpointRequest<
  IEndpoints['GET /groups/{group-id}/sites/{site-id}/onenote/notebooks/{notebook-id}']['response']
> {
  return {
    ver: 'beta',
    method: 'get',
...
/**
 * `PATCH /groups/{group-id}/sites/{site-id}/onenote/notebooks/{notebook-id}`
 *
 */
export function update(
  body: IEndpoints['PATCH /groups/{group-id}/sites/{site-id}/onenote/notebooks/{notebook-id}']['body'],
  params?: IEndpoints['PATCH /groups/{group-id}/sites/{site-id}/onenote/notebooks/{notebook-id}']['parameters']
): EndpointRequest<
  IEndpoints['PATCH /groups/{group-id}/sites/{site-id}/onenote/notebooks/{notebook-id}']['response']
> {
  return {
    ver: 'beta',
    method: 'patch',
...
/**
 * `POST /groups/{group-id}/sites/{site-id}/onenote/notebooks`
 *
 */
export function create(
  body: IEndpoints['POST /groups/{group-id}/sites/{site-id}/onenote/notebooks']['body'],
  params?: IEndpoints['POST /groups/{group-id}/sites/{site-id}/onenote/notebooks']['parameters']
): EndpointRequest<
  IEndpoints['POST /groups/{group-id}/sites/{site-id}/onenote/notebooks']['response']
> {
  return {
    ver: 'beta',
    method: 'post',
