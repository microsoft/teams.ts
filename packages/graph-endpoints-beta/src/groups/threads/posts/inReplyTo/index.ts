...
export interface IEndpoints {
  ...
  'POST /groups/{group-id}/threads/{conversationThread-id}/posts/{post-id}/inReplyTo/forward': Operation<
    ...
    'post'
  >;
  'GET /groups/{group-id}/threads/{conversationThread-id}/posts/{post-id}/inReplyTo/mentions': Operation<
    '/groups/{group-id}/threads/{conversationThread-id}/posts/{post-id}/inReplyTo/mentions',
    'get'
  >;
  'POST /groups/{group-id}/threads/{conversationThread-id}/posts/{post-id}/inReplyTo/mentions': Operation<
    '/groups/{group-id}/threads/{conversationThread-id}/posts/{post-id}/inReplyTo/mentions',
    'post'
  >;
  'GET /groups/{group-id}/threads/{conversationThread-id}/posts/{post-id}/inReplyTo/mentions/{mention-id}': Operation<
    '/groups/{group-id}/threads/{conversationThread-id}/posts/{post-id}/inReplyTo/mentions/{mention-id}',
    'get'
  >;
  'DELETE /groups/{group-id}/threads/{conversationThread-id}/posts/{post-id}/inReplyTo/mentions/{mention-id}': Operation<
    '/groups/{group-id}/threads/{conversationThread-id}/posts/{post-id}/inReplyTo/mentions/{mention-id}',
    'delete'
  >;
...
export const mentions = {
  /**
   * `GET /groups/{group-id}/threads/{conversationThread-id}/posts/{post-id}/inReplyTo/mentions`
   *
   */
  list: function list(
    params?: IEndpoints['GET /groups/{group-id}/threads/{conversationThread-id}/posts/{post-id}/inReplyTo/mentions']['parameters']
  ): EndpointRequest<
    IEndpoints['GET /groups/{group-id}/threads/{conversationThread-id}/posts/{post-id}/inReplyTo/mentions']['response']
  > {
    return {
      ver: 'beta',
      method: 'get',
      path: '/groups/{group-id}/threads/{conversationThread-id}/posts/{post-id}/inReplyTo/mentions',
      paramDefs: {
        query: ['$top', '$skip', '$search', '$filter', '$count', '$orderby', '$select', '$expand'],
        path: ['group-id', 'conversationThread-id', 'post-id'],
      },
  ...
  /**
   * `POST /groups/{group-id}/threads/{conversationThread-id}/posts/{post-id}/inReplyTo/mentions`
   *
   */
  create: function create(
    body: IEndpoints['POST /groups/{group-id}/threads/{conversationThread-id}/posts/{post-id}/inReplyTo/mentions']['body'],
    params?: IEndpoints['POST /groups/{group-id}/threads/{conversationThread-id}/posts/{post-id}/inReplyTo/mentions']['parameters']
  ): EndpointRequest<
    IEndpoints['POST /groups/{group-id}/threads/{conversationThread-id}/posts/{post-id}/inReplyTo/mentions']['response']
  > {
    return {
      ver: 'beta',
      method: 'post',
  ...
  /**
   * `GET /groups/{group-id}/threads/{conversationThread-id}/posts/{post-id}/inReplyTo/mentions/{mention-id}`
   *
   */
  get: function get(
    params?: IEndpoints['GET /groups/{group-id}/threads/{conversationThread-id}/posts/{post-id}/inReplyTo/mentions/{mention-id}']['parameters']
  ): EndpointRequest<
    IEndpoints['GET /groups/{group-id}/threads/{conversationThread-id}/posts/{post-id}/inReplyTo/mentions/{mention-id}']['response']
  > {
    return {
      ver: 'beta',
      method: 'get',
      path: '/groups/{group-id}/threads/{conversationThread-id}/posts/{post-id}/inReplyTo/mentions/{mention-id}',
      paramDefs: {
        query: ['$select', '$expand'],
  ...
  /**
   * `DELETE /groups/{group-id}/threads/{conversationThread-id}/posts/{post-id}/inReplyTo/mentions/{mention-id}`
   *
   */
  del: function del(
    params?: IEndpoints['DELETE /groups/{group-id}/threads/{conversationThread-id}/posts/{post-id}/inReplyTo/mentions/{mention-id}']['parameters']
  ): EndpointRequest<
    IEndpoints['DELETE /groups/{group-id}/threads/{conversationThread-id}/posts/{post-id}/inReplyTo/mentions/{mention-id}']['response']
  > {
    return {
      ver: 'beta',
      method: 'delete',
