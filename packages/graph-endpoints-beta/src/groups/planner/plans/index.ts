...
export interface IEndpoints {
  ...
  'POST /groups/{group-id}/planner/plans/{plannerPlan-id}/archive': Operation<
    '/groups/{group-id}/planner/plans/{plannerPlan-id}/archive',
    'post'
  >;
  ...
  'DELETE /groups/{group-id}/planner/plans/{plannerPlan-id}/details': Operation<
    ...
    'delete'
  >;
  'POST /groups/{group-id}/planner/plans/{plannerPlan-id}/moveToContainer': Operation<
    '/groups/{group-id}/planner/plans/{plannerPlan-id}/moveToContainer',
    'post'
  >;
  'POST /groups/{group-id}/planner/plans/{plannerPlan-id}/unarchive': Operation<
    '/groups/{group-id}/planner/plans/{plannerPlan-id}/unarchive',
    'post'
  >;
}
...
export const archive = {
  /**
   * `POST /groups/{group-id}/planner/plans/{plannerPlan-id}/archive`
   *
  ...
  create: function create(
    body: IEndpoints['POST /groups/{group-id}/planner/plans/{plannerPlan-id}/archive']['body'],
    params?: IEndpoints['POST /groups/{group-id}/planner/plans/{plannerPlan-id}/archive']['parameters']
  ): EndpointRequest<
    IEndpoints['POST /groups/{group-id}/planner/plans/{plannerPlan-id}/archive']['response']
  > {
    return {
      ver: 'beta',
      method: 'post',
      path: '/groups/{group-id}/planner/plans/{plannerPlan-id}/archive',
      paramDefs: {
        path: ['group-id', 'plannerPlan-id'],
      },
      params,
...
export const moveToContainer = {
  /**
   * `POST /groups/{group-id}/planner/plans/{plannerPlan-id}/moveToContainer`
   *
   ...
   */
  create: function create(
    body: IEndpoints['POST /groups/{group-id}/planner/plans/{plannerPlan-id}/moveToContainer']['body'],
    params?: IEndpoints['POST /groups/{group-id}/planner/plans/{plannerPlan-id}/moveToContainer']['parameters']
  ): EndpointRequest<
    IEndpoints['POST /groups/{group-id}/planner/plans/{plannerPlan-id}/moveToContainer']['response']
  > {
    return {
      ver: 'beta',
      method: 'post',
      path: '/groups/{group-id}/planner/plans/{plannerPlan-id}/moveToContainer',
      paramDefs: {
        path: ['group-id', 'plannerPlan-id'],
      },
      params,
...
export const unarchive = {
  /**
   * `POST /groups/{group-id}/planner/plans/{plannerPlan-id}/unarchive`
   *
   ...
   */
  create: function create(
    body: IEndpoints['POST /groups/{group-id}/planner/plans/{plannerPlan-id}/unarchive']['body'],
    params?: IEndpoints['POST /groups/{group-id}/planner/plans/{plannerPlan-id}/unarchive']['parameters']
  ): EndpointRequest<
    IEndpoints['POST /groups/{group-id}/planner/plans/{plannerPlan-id}/unarchive']['response']
  > {
    return {
      ver: 'beta',
      method: 'post',
      path: '/groups/{group-id}/planner/plans/{plannerPlan-id}/unarchive',
      paramDefs: {
        path: ['group-id', 'plannerPlan-id'],
      },
      params,
