...
export type CloudEnvironment = {
  ...
  /** The Agent User Bot API token scope. */
  readonly agentUserBotScope: string;
};
...
export const PUBLIC: CloudEnvironment = Object.freeze({
  ...
  agentUserBotScope: 'https://botapi.skype.com/.default',
});
...
export const US_GOV: CloudEnvironment = Object.freeze({
  ...
  // TODO: Use the sovereign Agent User Bot API scope when one is available.
  agentUserBotScope: 'https://botapi.skype.com/.default',
});
...
export const CHINA: CloudEnvironment = Object.freeze({
  ...
  // TODO: Use the China cloud Agent User Bot API scope when one is available.
  agentUserBotScope: 'https://botapi.skype.com/.default',
});
...
export function withOverrides(
  ...
  return Object.freeze({
    ...
    agentUserBotScope: overrides.agentUserBotScope ?? base.agentUserBotScope,
  });
}
