...
export const teamsApp = {
   ...
   */
  get: function get(
    params?: IEndpoints['GET /teams/{team-id}/primaryChannel/tabs/{teamsTab-id}/teamsApp']['parameters']
  ): EndpointRequest<
    IEndpoints['GET /teams/{team-id}/primaryChannel/tabs/{teamsTab-id}/teamsApp']['response']
  > {
    return {
      method: 'get',
      path: '/teams/{team-id}/primaryChannel/tabs/{teamsTab-id}/teamsApp',
      paramDefs: {
        query: ['$select', '$expand'],
        path: ['team-id', 'teamsTab-id'],
      },
