...
export interface IEndpoints {
  ...
  'GET /users/{user-id}/calendar/events/{event-id}/calendar': Operation<
    ...
    'get'
  >;
  'POST /users/{user-id}/calendar/events/{event-id}/cancel': Operation<
    '/users/{user-id}/calendar/events/{event-id}/cancel',
    'post'
  >;
  'POST /users/{user-id}/calendar/events/{event-id}/decline': Operation<
    '/users/{user-id}/calendar/events/{event-id}/decline',
    'post'
  >;
  'POST /users/{user-id}/calendar/events/{event-id}/dismissReminder': Operation<
    '/users/{user-id}/calendar/events/{event-id}/dismissReminder',
    'post'
  >;
  'GET /users/{user-id}/calendar/events/{event-id}/extensions': Operation<
    '/users/{user-id}/calendar/events/{event-id}/extensions',
    'get'
  >;
  'POST /users/{user-id}/calendar/events/{event-id}/extensions': Operation<
    '/users/{user-id}/calendar/events/{event-id}/extensions',
    'post'
  >;
  'GET /users/{user-id}/calendar/events/{event-id}/extensions/{extension-id}': Operation<
    '/users/{user-id}/calendar/events/{event-id}/extensions/{extension-id}',
    'get'
  >;
  'PATCH /users/{user-id}/calendar/events/{event-id}/extensions/{extension-id}': Operation<
    '/users/{user-id}/calendar/events/{event-id}/extensions/{extension-id}',
    'patch'
  >;
  'DELETE /users/{user-id}/calendar/events/{event-id}/extensions/{extension-id}': Operation<
    '/users/{user-id}/calendar/events/{event-id}/extensions/{extension-id}',
    'delete'
  >;
  'POST /users/{user-id}/calendar/events/{event-id}/forward': Operation<
    '/users/{user-id}/calendar/events/{event-id}/forward',
    'post'
  >;
  'GET /users/{user-id}/calendar/events/{event-id}/instances': Operation<
    '/users/{user-id}/calendar/events/{event-id}/instances',
    'get'
  >;
  'POST /users/{user-id}/calendar/events/{event-id}/permanentDelete': Operation<
  ...
  'POST /users/{user-id}/calendar/events/{event-id}/snoozeReminder': Operation<
    ...
    'post'
  >;
  'POST /users/{user-id}/calendar/events/{event-id}/tentativelyAccept': Operation<
...
export const cancel = {
  /**
  * `POST /users/{user-id}/calendar/events/{event-id}/cancel`
  *
...
the organizer send a custom message to the attendees about the cancellation.
  */
  create: function create(
    body: IEndpoints['POST /users/{user-id}/calendar/events/{event-id}/cancel']['body'],
    params?: IEndpoints['POST /users/{user-id}/calendar/events/{event-id}/cancel']['parameters']
  ): EndpointRequest<
    IEndpoints['POST /users/{user-id}/calendar/events/{event-id}/cancel']['response']
  > {
    return {
      method: 'post',
...
export const decline = {
   ...
   */
  create: function create(
    body: IEndpoints['POST /users/{user-id}/calendar/events/{event-id}/decline']['body'],
    params?: IEndpoints['POST /users/{user-id}/calendar/events/{event-id}/decline']['parameters']
  ): EndpointRequest<
    IEndpoints['POST /users/{user-id}/calendar/events/{event-id}/decline']['response']
  > {
    return {
      method: 'post',
...
export const dismissReminder = {
  /**
   * `POST /users/{user-id}/calendar/events/{event-id}/dismissReminder`
   *
   * Dismiss a reminder that has been triggered for an event in a user calendar.
   */
  create: function create(
    params?: IEndpoints['POST /users/{user-id}/calendar/events/{event-id}/dismissReminder']['parameters']
  ): EndpointRequest<
    IEndpoints['POST /users/{user-id}/calendar/events/{event-id}/dismissReminder']['response']
  > {
    return {
      method: 'post',
...
export const extensions = {
   ...
   */
  list: function list(
    params?: IEndpoints['GET /users/{user-id}/calendar/events/{event-id}/extensions']['parameters']
  ): EndpointRequest<
    IEndpoints['GET /users/{user-id}/calendar/events/{event-id}/extensions']['response']
  > {
    return {
      method: 'get',
   ...
   */
  create: function create(
    body: IEndpoints['POST /users/{user-id}/calendar/events/{event-id}/extensions']['body'],
    params?: IEndpoints['POST /users/{user-id}/calendar/events/{event-id}/extensions']['parameters']
  ): EndpointRequest<
    IEndpoints['POST /users/{user-id}/calendar/events/{event-id}/extensions']['response']
  > {
    return {
      method: 'post',
      path: '/users/{user-id}/calendar/events/{event-id}/extensions',
   ...
   */
  get: function get(
    params?: IEndpoints['GET /users/{user-id}/calendar/events/{event-id}/extensions/{extension-id}']['parameters']
  ): EndpointRequest<
    IEndpoints['GET /users/{user-id}/calendar/events/{event-id}/extensions/{extension-id}']['response']
  > {
    return {
      method: 'get',
      ...
      paramDefs: {
        query: ['$select', '$expand'],
        path: ['user-id', 'event-id', 'extension-id'],
      },
      params,
    };
  },
  ...
  update: function update(
    body: IEndpoints['PATCH /users/{user-id}/calendar/events/{event-id}/extensions/{extension-id}']['body'],
    params?: IEndpoints['PATCH /users/{user-id}/calendar/events/{event-id}/extensions/{extension-id}']['parameters']
  ): EndpointRequest<
    IEndpoints['PATCH /users/{user-id}/calendar/events/{event-id}/extensions/{extension-id}']['response']
  > {
    return {
      method: 'patch',
      path: '/users/{user-id}/calendar/events/{event-id}/extensions/{extension-id}',
   ...
   */
  del: function del(
    params?: IEndpoints['DELETE /users/{user-id}/calendar/events/{event-id}/extensions/{extension-id}']['parameters']
  ): EndpointRequest<
    IEndpoints['DELETE /users/{user-id}/calendar/events/{event-id}/extensions/{extension-id}']['response']
  > {
    return {
      method: 'delete',
      path: '/users/{user-id}/calendar/events/{event-id}/extensions/{extension-id}',
...
export const forward = {
  /**
  * `POST /users/{user-id}/calendar/events/{event-id}/forward`
  *
...
copy of the meeting event. This convenience is not available when forwarding from an Outlook.com account.
  */
  create: function create(
    body: IEndpoints['POST /users/{user-id}/calendar/events/{event-id}/forward']['body'],
    params?: IEndpoints['POST /users/{user-id}/calendar/events/{event-id}/forward']['parameters']
  ): EndpointRequest<
    IEndpoints['POST /users/{user-id}/calendar/events/{event-id}/forward']['response']
  > {
    return {
      method: 'post',
...
export const instances = {
   ...
   */
  list: function list(
    params?: IEndpoints['GET /users/{user-id}/calendar/events/{event-id}/instances']['parameters']
  ): EndpointRequest<
    IEndpoints['GET /users/{user-id}/calendar/events/{event-id}/instances']['response']
  > {
    return {
      method: 'get',
...
export const permanentDelete = {
  /**
   * `POST /users/{user-id}/calendar/events/{event-id}/permanentDelete`
   *
   */
  create: function create(
    params?: IEndpoints['POST /users/{user-id}/calendar/events/{event-id}/permanentDelete']['parameters']
  ): EndpointRequest<
    IEndpoints['POST /users/{user-id}/calendar/events/{event-id}/permanentDelete']['response']
  > {
    return {
      method: 'post',
...
export const tentativelyAccept = {
   ...
   */
  create: function create(
    body: IEndpoints['POST /users/{user-id}/calendar/events/{event-id}/tentativelyAccept']['body'],
    params?: IEndpoints['POST /users/{user-id}/calendar/events/{event-id}/tentativelyAccept']['parameters']
  ): EndpointRequest<
    IEndpoints['POST /users/{user-id}/calendar/events/{event-id}/tentativelyAccept']['response']
  > {
    return {
      method: 'post',
