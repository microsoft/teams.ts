...
export interface IEndpoints {
  ...
  'POST /sites/{site-id}/contentTypes/addCopy': Operation<
    ...
    'post'
  >;
  'POST /sites/{site-id}/contentTypes/addCopyFromContentTypeHub': Operation<
...
export const addCopyFromContentTypeHub = {
  /**
   * `POST /sites/{site-id}/contentTypes/addCopyFromContentTypeHub`
   *
   ...
   */
  create: function create(
    body: IEndpoints['POST /sites/{site-id}/contentTypes/addCopyFromContentTypeHub']['body'],
    params?: IEndpoints['POST /sites/{site-id}/contentTypes/addCopyFromContentTypeHub']['parameters']
  ): EndpointRequest<
    IEndpoints['POST /sites/{site-id}/contentTypes/addCopyFromContentTypeHub']['response']
  > {
    return {
      method: 'post',
      path: '/sites/{site-id}/contentTypes/addCopyFromContentTypeHub',
      paramDefs: {
        path: ['site-id'],
      },
      params,
...
export const base = {
  /**
   * `GET /sites/{site-id}/contentTypes/{contentType-id}/base`
   *
   * Parent contentType from which this content type is derived.
   */
  get: function get(
    params?: IEndpoints['GET /sites/{site-id}/contentTypes/{contentType-id}/base']['parameters']
  ): EndpointRequest<
    IEndpoints['GET /sites/{site-id}/contentTypes/{contentType-id}/base']['response']
  > {
    return {
      method: 'get',
      path: '/sites/{site-id}/contentTypes/{contentType-id}/base',
      paramDefs: {
        query: ['$select', '$expand'],
        path: ['site-id', 'contentType-id'],
      },
...
export const baseTypes = {
  ...
  > {
    return {
      ...
      paramDefs: {
        query: ['$select', '$expand'],
        path: ['site-id', 'contentType-id', 'contentType-id1'],
      },
      params,
    };
  },
...
export const columnLinks = {
  ...
  > {
    return {
      ...
      paramDefs: {
        query: ['$select', '$expand'],
        path: ['site-id', 'contentType-id', 'columnLink-id'],
      },
      params,
    };
  },
