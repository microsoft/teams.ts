...
export interface IEndpoints {
  ...
  'PATCH /shares/{sharedDriveItem-id}/lastModifiedByUser/mailboxSettings': Operation<
    ...
    'patch'
  >;
  'GET /shares/{sharedDriveItem-id}/lastModifiedByUser/serviceProvisioningErrors': Operation<
...
export const serviceProvisioningErrors = {
  /**
   * `GET /shares/{sharedDriveItem-id}/lastModifiedByUser/serviceProvisioningErrors`
   *
   * Errors published by a federated service describing a nontransient, service-specific error regarding the properties or link from a user object.  Supports $filter (eq, not, for isResolved and serviceInstance).
   */
  list: function list(
    params?: IEndpoints['GET /shares/{sharedDriveItem-id}/lastModifiedByUser/serviceProvisioningErrors']['parameters']
  ): EndpointRequest<
    IEndpoints['GET /shares/{sharedDriveItem-id}/lastModifiedByUser/serviceProvisioningErrors']['response']
  > {
    return {
      method: 'get',
