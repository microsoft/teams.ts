...
export interface IEndpoints {
  ...
  'POST /me/joinedTeams/{team-id}/primaryChannel/tabs': Operation<
    ...
    'post'
  >;
  'GET /me/joinedTeams/{team-id}/primaryChannel/tabs/{teamsTab-id}/teamsApp': Operation<
...
export const teamsApp = {
  /**
   * `GET /me/joinedTeams/{team-id}/primaryChannel/tabs/{teamsTab-id}/teamsApp`
   *
   * The application that is linked to the tab. This can&#x27;t be changed after tab creation.
   */
  get: function get(
    params?: IEndpoints['GET /me/joinedTeams/{team-id}/primaryChannel/tabs/{teamsTab-id}/teamsApp']['parameters']
  ): EndpointRequest<
    IEndpoints['GET /me/joinedTeams/{team-id}/primaryChannel/tabs/{teamsTab-id}/teamsApp']['response']
  > {
    return {
      method: 'get',
