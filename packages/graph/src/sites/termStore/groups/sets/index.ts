...
export class SetsClient {
  protected baseUrl = '/sites/{site-id}/termStore/groups/{group-id}/sets';
   ...
   */
  async delete(
    params?: Endpoints['DELETE /sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}']['parameters'],
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['DELETE /sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}']['response']
      );
  }
   ...
   */
  async list(
    params?: Endpoints['GET /sites/{site-id}/termStore/groups/{group-id}/sets']['parameters'],
    config?: http.RequestConfig
  ) {
    const url = getInjectedUrl(
      '/sites/{site-id}/termStore/groups/{group-id}/sets',
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['GET /sites/{site-id}/termStore/groups/{group-id}/sets']['response']
      );
  }
   ...
   */
  async get(
    params?: Endpoints['GET /sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}']['parameters'],
    config?: http.RequestConfig
  ) {
    const url = getInjectedUrl(
      '/sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}',
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['GET /sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}']['response']
      );
  }
   ...
   */
  async update(
    body: Endpoints['PATCH /sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}']['body'],
    params?: Endpoints['PATCH /sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}']['parameters'],
    config?: http.RequestConfig
  ) {
    const url = getInjectedUrl(
      '/sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}',
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['PATCH /sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}']['response']
      );
  }
   ...
   */
  async create(
    body: Endpoints['POST /sites/{site-id}/termStore/groups/{group-id}/sets']['body'],
    params?: Endpoints['POST /sites/{site-id}/termStore/groups/{group-id}/sets']['parameters'],
    config?: http.RequestConfig
  ) {
    const url = getInjectedUrl(
      '/sites/{site-id}/termStore/groups/{group-id}/sets',
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['POST /sites/{site-id}/termStore/groups/{group-id}/sets']['response']
      );
  }
}
