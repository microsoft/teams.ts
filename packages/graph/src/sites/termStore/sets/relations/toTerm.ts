...
export class ToTermClient {
  protected baseUrl = '/sites/{site-id}/termStore/sets/{set-id}/relations/{relation-id}/toTerm';
   ...
   */
  async get(
    params?: Endpoints['GET /sites/{site-id}/termStore/sets/{set-id}/relations/{relation-id}/toTerm']['parameters'],
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['GET /sites/{site-id}/termStore/sets/{set-id}/relations/{relation-id}/toTerm']['response']
      );
  }
}
