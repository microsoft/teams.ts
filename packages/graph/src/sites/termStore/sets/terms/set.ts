...
export class SetClient {
  protected baseUrl = '/sites/{site-id}/termStore/sets/{set-id}/terms/{term-id}/set';
   ...
   */
  async get(
    params?: Endpoints['GET /sites/{site-id}/termStore/sets/{set-id}/terms/{term-id}/set']['parameters'],
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['GET /sites/{site-id}/termStore/sets/{set-id}/terms/{term-id}/set']['response']
      );
  }
}
