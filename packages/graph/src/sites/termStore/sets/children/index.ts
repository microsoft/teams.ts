...
export class ChildrenClient {
  protected baseUrl = '/sites/{site-id}/termStore/sets/{set-id}/children';
   ...
   */
  async delete(
    params?: Endpoints['DELETE /sites/{site-id}/termStore/sets/{set-id}/children/{term-id}']['parameters'],
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['DELETE /sites/{site-id}/termStore/sets/{set-id}/children/{term-id}']['response']
      );
  }
   ...
   */
  async get(
    params?: Endpoints['GET /sites/{site-id}/termStore/sets/{set-id}/children']['parameters'],
    config?: http.RequestConfig
  ) {
    const url = getInjectedUrl(
      '/sites/{site-id}/termStore/sets/{set-id}/children',
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['GET /sites/{site-id}/termStore/sets/{set-id}/children']['response']
      );
  }
   ...
   */
  async get$1(
    params?: Endpoints['GET /sites/{site-id}/termStore/sets/{set-id}/children/{term-id}']['parameters'],
    config?: http.RequestConfig
  ) {
    const url = getInjectedUrl(
      '/sites/{site-id}/termStore/sets/{set-id}/children/{term-id}',
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['GET /sites/{site-id}/termStore/sets/{set-id}/children/{term-id}']['response']
      );
  }
   ...
   */
  async update(
    body: Endpoints['PATCH /sites/{site-id}/termStore/sets/{set-id}/children/{term-id}']['body'],
    params?: Endpoints['PATCH /sites/{site-id}/termStore/sets/{set-id}/children/{term-id}']['parameters'],
    config?: http.RequestConfig
  ) {
    const url = getInjectedUrl(
      '/sites/{site-id}/termStore/sets/{set-id}/children/{term-id}',
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['PATCH /sites/{site-id}/termStore/sets/{set-id}/children/{term-id}']['response']
      );
  }
   ...
   */
  async create(
    body: Endpoints['POST /sites/{site-id}/termStore/sets/{set-id}/children']['body'],
    params?: Endpoints['POST /sites/{site-id}/termStore/sets/{set-id}/children']['parameters'],
    config?: http.RequestConfig
  ) {
    const url = getInjectedUrl(
      '/sites/{site-id}/termStore/sets/{set-id}/children',
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['POST /sites/{site-id}/termStore/sets/{set-id}/children']['response']
      );
  }
}
