...
export class SetClient {
  protected baseUrl = '/sites/{site-id}/termStore/sets/{set-id}/children/{term-id}/set';
   ...
   */
  async get(
    params?: Endpoints['GET /sites/{site-id}/termStore/sets/{set-id}/children/{term-id}/set']['parameters'],
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['GET /sites/{site-id}/termStore/sets/{set-id}/children/{term-id}/set']['response']
      );
  }
}
