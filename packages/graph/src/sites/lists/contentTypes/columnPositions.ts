...
export class ColumnPositionsClient {
   ...
   */
  async list(
    params?: Endpoints['GET /sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/columnPositions']['parameters'],
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['GET /sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/columnPositions']['response']
      );
  }
   ...
   */
  async get(
    params?: Endpoints['GET /sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/columnPositions/{columnDefinition-id}']['parameters'],
    config?: http.RequestConfig
  ) {
    const url = getInjectedUrl(
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['GET /sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/columnPositions/{columnDefinition-id}']['response']
      );
  }
}
