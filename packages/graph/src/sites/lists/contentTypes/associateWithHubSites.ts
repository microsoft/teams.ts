...
export class AssociateWithHubSitesClient {
   ...
   */
  async create(
    body: Endpoints['POST /sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/associateWithHubSites']['body'],
    params?: Endpoints['POST /sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/associateWithHubSites']['parameters'],
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['POST /sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/associateWithHubSites']['response']
      );
  }
}
