...
export class CreatedByUserClient {
  protected baseUrl = '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/createdByUser';
   ...
   */
  async get(
    params?: Endpoints['GET /sites/{site-id}/lists/{list-id}/items/{listItem-id}/createdByUser']['parameters'],
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['GET /sites/{site-id}/lists/{list-id}/items/{listItem-id}/createdByUser']['response']
      );
  }
}
