...
export class LastModifiedByUserClient {
  protected baseUrl = '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/lastModifiedByUser';
   ...
   */
  async get(
    params?: Endpoints['GET /sites/{site-id}/lists/{list-id}/items/{listItem-id}/lastModifiedByUser']['parameters'],
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['GET /sites/{site-id}/lists/{list-id}/items/{listItem-id}/lastModifiedByUser']['response']
      );
  }
}
