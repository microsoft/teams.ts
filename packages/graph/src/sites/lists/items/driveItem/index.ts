...
export class DriveItemClient {
  protected baseUrl = '/sites/{site-id}/lists/{list-id}/items/{listItem-id}/driveItem';
   ...
   */
  async get(
    params?: Endpoints['GET /sites/{site-id}/lists/{list-id}/items/{listItem-id}/driveItem']['parameters'],
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['GET /sites/{site-id}/lists/{list-id}/items/{listItem-id}/driveItem']['response']
      );
  }
}
