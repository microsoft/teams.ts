...
export class SourceColumnClient {
  protected baseUrl = '/sites/{site-id}/lists/{list-id}/columns/{columnDefinition-id}/sourceColumn';
   ...
   */
  async get(
    params?: Endpoints['GET /sites/{site-id}/lists/{list-id}/columns/{columnDefinition-id}/sourceColumn']['parameters'],
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['GET /sites/{site-id}/lists/{list-id}/columns/{columnDefinition-id}/sourceColumn']['response']
      );
  }
}
