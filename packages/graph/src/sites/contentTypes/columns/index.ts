...
export class ColumnsClient {
  protected baseUrl = '/sites/{site-id}/contentTypes/{contentType-id}/columns';
   ...
   */
  async delete(
    params?: Endpoints['DELETE /sites/{site-id}/contentTypes/{contentType-id}/columns/{columnDefinition-id}']['parameters'],
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['DELETE /sites/{site-id}/contentTypes/{contentType-id}/columns/{columnDefinition-id}']['response']
      );
  }
   ...
   */
  async list(
    params?: Endpoints['GET /sites/{site-id}/contentTypes/{contentType-id}/columns']['parameters'],
    config?: http.RequestConfig
  ) {
    const url = getInjectedUrl(
      '/sites/{site-id}/contentTypes/{contentType-id}/columns',
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['GET /sites/{site-id}/contentTypes/{contentType-id}/columns']['response']
      );
  }
   ...
   */
  async get(
    params?: Endpoints['GET /sites/{site-id}/contentTypes/{contentType-id}/columns/{columnDefinition-id}']['parameters'],
    config?: http.RequestConfig
  ) {
    const url = getInjectedUrl(
      '/sites/{site-id}/contentTypes/{contentType-id}/columns/{columnDefinition-id}',
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['GET /sites/{site-id}/contentTypes/{contentType-id}/columns/{columnDefinition-id}']['response']
      );
  }
   ...
   */
  async update(
    body: Endpoints['PATCH /sites/{site-id}/contentTypes/{contentType-id}/columns/{columnDefinition-id}']['body'],
    params?: Endpoints['PATCH /sites/{site-id}/contentTypes/{contentType-id}/columns/{columnDefinition-id}']['parameters'],
    config?: http.RequestConfig
  ) {
    const url = getInjectedUrl(
      '/sites/{site-id}/contentTypes/{contentType-id}/columns/{columnDefinition-id}',
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['PATCH /sites/{site-id}/contentTypes/{contentType-id}/columns/{columnDefinition-id}']['response']
      );
  }
   ...
   */
  async create(
    body: Endpoints['POST /sites/{site-id}/contentTypes/{contentType-id}/columns']['body'],
    params?: Endpoints['POST /sites/{site-id}/contentTypes/{contentType-id}/columns']['parameters'],
    config?: http.RequestConfig
  ) {
    const url = getInjectedUrl(
      '/sites/{site-id}/contentTypes/{contentType-id}/columns',
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['POST /sites/{site-id}/contentTypes/{contentType-id}/columns']['response']
      );
  }
}
