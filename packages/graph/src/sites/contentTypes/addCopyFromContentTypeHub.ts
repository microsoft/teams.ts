...
export class AddCopyFromContentTypeHubClient {
  protected baseUrl = '/sites/{site-id}/contentTypes/addCopyFromContentTypeHub';
   ...
   */
  async create(
    body: Endpoints['POST /sites/{site-id}/contentTypes/addCopyFromContentTypeHub']['body'],
    params?: Endpoints['POST /sites/{site-id}/contentTypes/addCopyFromContentTypeHub']['parameters'],
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['POST /sites/{site-id}/contentTypes/addCopyFromContentTypeHub']['response']
      );
  }
}
