...
export class ParentNotebookClient {
  protected baseUrl = '/sites/{site-id}/onenote/pages/{onenotePage-id}/parentNotebook';
   ...
   */
  async get(
    params?: Endpoints['GET /sites/{site-id}/onenote/pages/{onenotePage-id}/parentNotebook']['parameters'],
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['GET /sites/{site-id}/onenote/pages/{onenotePage-id}/parentNotebook']['response']
      );
  }
}
