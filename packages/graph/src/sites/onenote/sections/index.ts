...
export class SectionsClient {
  protected baseUrl = '/sites/{site-id}/onenote/sections';
   ...
   */
  async delete(
    params?: Endpoints['DELETE /sites/{site-id}/onenote/sections/{onenoteSection-id}']['parameters'],
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['DELETE /sites/{site-id}/onenote/sections/{onenoteSection-id}']['response']
      );
  }
   ...
   */
  async list(
    params?: Endpoints['GET /sites/{site-id}/onenote/sections']['parameters'],
    config?: http.RequestConfig
  ) {
    const url = getInjectedUrl(
      '/sites/{site-id}/onenote/sections',
    ...
    return this.http
      .get(url, config)
      .then((res) => res.data as Endpoints['GET /sites/{site-id}/onenote/sections']['response']);
  }
   ...
   */
  async get(
    params?: Endpoints['GET /sites/{site-id}/onenote/sections/{onenoteSection-id}']['parameters'],
    config?: http.RequestConfig
  ) {
    const url = getInjectedUrl(
      '/sites/{site-id}/onenote/sections/{onenoteSection-id}',
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['GET /sites/{site-id}/onenote/sections/{onenoteSection-id}']['response']
      );
  }
   ...
   */
  async update(
    body: Endpoints['PATCH /sites/{site-id}/onenote/sections/{onenoteSection-id}']['body'],
    params?: Endpoints['PATCH /sites/{site-id}/onenote/sections/{onenoteSection-id}']['parameters'],
    config?: http.RequestConfig
  ) {
    const url = getInjectedUrl(
      '/sites/{site-id}/onenote/sections/{onenoteSection-id}',
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['PATCH /sites/{site-id}/onenote/sections/{onenoteSection-id}']['response']
      );
  }
   ...
   */
  async create(
    body: Endpoints['POST /sites/{site-id}/onenote/sections']['body'],
    params?: Endpoints['POST /sites/{site-id}/onenote/sections']['parameters'],
    config?: http.RequestConfig
  ) {
    const url = getInjectedUrl(
      '/sites/{site-id}/onenote/sections',
    ...
    return this.http
      ...
      .then((res) => res.data as Endpoints['POST /sites/{site-id}/onenote/sections']['response']);
  }
}
