...
export class LastModifiedByUserClient {
  protected baseUrl = '/sites/{site-id}/pages/{baseSitePage-id}/lastModifiedByUser';
   ...
   */
  async get(
    params?: Endpoints['GET /sites/{site-id}/pages/{baseSitePage-id}/lastModifiedByUser']['parameters'],
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['GET /sites/{site-id}/pages/{baseSitePage-id}/lastModifiedByUser']['response']
      );
  }
}
