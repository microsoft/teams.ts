...
export class CreatedByUserClient {
  protected baseUrl = '/sites/{site-id}/createdByUser';
   ...
   */
  async get(
    params?: Endpoints['GET /sites/{site-id}/createdByUser']['parameters'],
    ...
    return this.http
      .get(url, config)
      .then((res) => res.data as Endpoints['GET /sites/{site-id}/createdByUser']['response']);
  }
}
