...
export class ExceptionOccurrencesClient {
  protected baseUrl = '/me/calendarView/{event-id}/exceptionOccurrences';
  ...
  /**
   * `/me/calendarView/{event-id}/exceptionOccurrences/{event-id1}/accept`
   *
  ...
  /**
   * `/me/calendarView/{event-id}/exceptionOccurrences/{event-id1}/calendar`
   *
  ...
  /**
   * `/me/calendarView/{event-id}/exceptionOccurrences/{event-id1}/cancel`
   *
  ...
  /**
   * `/me/calendarView/{event-id}/exceptionOccurrences/{event-id1}/decline`
   *
  ...
  /**
   * `/me/calendarView/{event-id}/exceptionOccurrences/{event-id1}/dismissReminder`
   *
  ...
  /**
   * `/me/calendarView/{event-id}/exceptionOccurrences/{event-id1}/forward`
   *
  ...
  /**
   * `/me/calendarView/{event-id}/exceptionOccurrences/{event-id1}/snoozeReminder`
   *
  ...
  /**
   * `/me/calendarView/{event-id}/exceptionOccurrences/{event-id1}/tentativelyAccept`
   *
  ...
  /**
   * `GET /me/calendarView/{event-id}/exceptionOccurrences`
   *
   */
  async list(
    params?: Endpoints['GET /me/calendarView/{event-id}/exceptionOccurrences']['parameters'],
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['GET /me/calendarView/{event-id}/exceptionOccurrences']['response']
      );
  }

  /**
   * `GET /me/calendarView/{event-id}/exceptionOccurrences/{event-id1}`
   *
   */
  async get(
    params?: Endpoints['GET /me/calendarView/{event-id}/exceptionOccurrences/{event-id1}']['parameters'],
    config?: http.RequestConfig
  ) {
    const url = getInjectedUrl(
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['GET /me/calendarView/{event-id}/exceptionOccurrences/{event-id1}']['response']
      );
  }
}
