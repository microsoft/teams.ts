...
export class CancelClient {
  ...
  /**
   * `POST /me/calendarView/{event-id}/exceptionOccurrences/{event-id1}/instances/{event-id2}/cancel`
   *
...
the organizer send a custom message to the attendees about the cancellation.
   */
  async create(
    body: Endpoints['POST /me/calendarView/{event-id}/exceptionOccurrences/{event-id1}/instances/{event-id2}/cancel']['body'],
    params?: Endpoints['POST /me/calendarView/{event-id}/exceptionOccurrences/{event-id1}/instances/{event-id2}/cancel']['parameters'],
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['POST /me/calendarView/{event-id}/exceptionOccurrences/{event-id1}/instances/{event-id2}/cancel']['response']
      );
  }
}
