...
export class ExceptionOccurrencesClient {
  protected baseUrl = '/me/calendar/events/{event-id}/exceptionOccurrences';
  ...
  /**
   * `/me/calendar/events/{event-id}/exceptionOccurrences/{event-id1}/accept`
   *
  ...
  /**
   * `/me/calendar/events/{event-id}/exceptionOccurrences/{event-id1}/calendar`
   *
  ...
  /**
   * `/me/calendar/events/{event-id}/exceptionOccurrences/{event-id1}/cancel`
   *
  ...
  /**
   * `/me/calendar/events/{event-id}/exceptionOccurrences/{event-id1}/decline`
   *
  ...
  /**
   * `/me/calendar/events/{event-id}/exceptionOccurrences/{event-id1}/dismissReminder`
   *
  ...
  /**
   * `/me/calendar/events/{event-id}/exceptionOccurrences/{event-id1}/forward`
   *
  ...
  /**
   * `/me/calendar/events/{event-id}/exceptionOccurrences/{event-id1}/snoozeReminder`
   *
  ...
  /**
   * `/me/calendar/events/{event-id}/exceptionOccurrences/{event-id1}/tentativelyAccept`
   *
  ...
  /**
   * `GET /me/calendar/events/{event-id}/exceptionOccurrences`
   *
   */
  async list(
    params?: Endpoints['GET /me/calendar/events/{event-id}/exceptionOccurrences']['parameters'],
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['GET /me/calendar/events/{event-id}/exceptionOccurrences']['response']
      );
  }

  /**
   * `GET /me/calendar/events/{event-id}/exceptionOccurrences/{event-id1}`
   *
   */
  async get(
    params?: Endpoints['GET /me/calendar/events/{event-id}/exceptionOccurrences/{event-id1}']['parameters'],
    config?: http.RequestConfig
  ) {
    const url = getInjectedUrl(
    ...
    return this.http
      ...
      .then(
        (res) =>
          res.data as Endpoints['GET /me/calendar/events/{event-id}/exceptionOccurrences/{event-id1}']['response']
      );
  }
}
